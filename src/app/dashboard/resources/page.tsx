...
const mockResources = [
  {
    id: 'res001',
    title: 'The Ultimate Guide to Affiliate Marketing in 2024',
    type: 'Article',
    category: 'Beginner Guides',
    description: 'Learn the fundamentals of affiliate marketing, from choosing a niche to driving traffic and converting sales.',
  ...
  {
    id: 'res002',
    title: 'Advanced SEO Strategies for Affiliate Websites',
    type: 'Article',
    category: 'SEO & Traffic',
    description: 'Boost your organic traffic with these proven SEO techniques tailored for affiliate marketers.',
  ...
  {
    id: 'res003',
    title: 'Video Tutorial: Setting Up Your First Campaign',
    type: 'Video',
    category: 'Campaign Management',
    description: 'A step-by-step video guide to creating and launching a successful affiliate marketing campaign.',
  ...
  {
    id: 'res004',
    title: 'How to Choose High-Converting Affiliate Products',
    type: 'Article',
    category: 'Product Selection',
    description: 'Discover the secrets to finding products that your audience will love and that will maximize your commissions.',
  ...
  {
    id: 'res005',
    title: 'Podcast: Interviews with Top Affiliate Earners',
    type: 'Podcast',
    category: 'Interviews & Insights',
    description: 'Hear from successful affiliate marketers who share their tips, tricks, and inspiring journeys.',
  ...
  {
    id: 'res006',
    title: 'Understanding Affiliate Marketing Analytics',
    type: 'Article',
    category: 'Analytics & Reporting',
    description: 'Make data-driven decisions by learning how to interpret key affiliate marketing metrics and reports.',
  ...
  return (
    <>
      <PageHeader
        ...
        description="Access guides, tutorials, and insights to help you succeed in affiliate marketing."
        icon={BookOpen}
      />
        ...
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <div className="md:col-span-1">
              <label htmlFor="search-resources" className="block text-sm font-medium text-muted-foreground mb-1">Search Resources</label>
      ...
      {mockResources.length === 0 && (
        <Card className="shadow-lg">
          <CardContent className="py-20 text-center text-muted-foreground">
            ...
            <p>Check back later for helpful guides and articles.</p>
          </CardContent>
        </Card>
      )}
    </>
